...
const FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Нет. Мы не используем вайбкдинг и не планируем. Все функции разрабатываются на основе реальных потребностей. Использовался Claude Opus 4.7 для генерации текстов, но с тщательной ручной доработкой и отбором, а также для тестрования безопасности мессенджера на уязвимости к атакам, инъекциям, XSS, CSRF.",
  },
];
